...
const VARIANTS = {
    ...
    Kırmızı: "bg-red-600 hover:bg-red-700",     
    // Eksik (Turuncu/Sarı) -> amber-500 (veya orange-500)
    Turuncu:   "bg-amber-600 hover:bg-amber-700",     
    // Yaptı (Yeşil) -> emerald-500 (veya green-500)
    Yeşil:   "bg-emerald-600 hover:bg-emerald-700",     
    // Gelmedi (Mor) -> violet-500 (veya purple-500)
    Mor: "bg-violet-600 hover:bg-violet-700",     
    // KitapYok (Gri) -> gray-600
    Gri:"bg-gray-600 hover:bg-gray-700", 
    // Varsayılan (Mavi) -> gray-600
    Default: "bg-blue-600 hover:bg-blue-700"
};
const Button = ({children, renk, name, onClick}) => {
  ...
  const baseClass = "flex items-center gap-2 text-white text-sm p-2 rounded-lg transition duration-150";
